...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public NewJFrame() {
        initComponents();
        System.out.println(jCheckBox1.getLabel());
        System.out.println(jLabel1.getText());
         System.out.println(jFormattedTextField1.getText());
         if(jFormattedTextField1.getText().indexOf("/")>=0)
             jFormattedTextField1.setText("44/55/5214");
         jTextArea1.setText("kkkkkk");
        jCheckBox1.setSelected(true);
        String[] strArray = {"abcd", "abdc", "bcda"};
        
        for (String s : strArray) 
            if(s.startsWith("abdc"))System.out.println(s);
